...
### DataOn - Application (Software) 등록
...
### 팀 프로젝트의 시너지 효과
- 팀원 모두가 전체 내용을 공유하고 여러 논의와 방향을 고민해가면서 투명한 의사소통의 중요성을 느꼈고, 혼자가 아닌 함께 헤쳐나가는 것에서 큰 시너지를 얻고 서로 힘낼 수 있는 팀의 효과를 느낀 의미있는 프로젝트였습니다.
